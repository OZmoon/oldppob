...
$tipe = "Verifikasi Akun";
	    ...
	    if (isset($_POST['kirim_kode'])) {
	        ...
	        $mail->IsSMTP();
	        $mail->SMTPSecure = 'ssl'; 
	        $mail->Host = "mail.putrazc.site"; //host masing2 provider email
	        $mail->SMTPDebug = 2;
	        $mail->Port = 465;
	        $mail->SMTPAuth = true;
	        $mail->Username = "support@putrazc.site"; //user email
	        $mail->Password = "wowosasgt1"; //password email 
	        $mail->SetFrom("support@putrazc.site","Support NoReply"); //set email pengirim
                ...
                <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width:600px;'>
                    <tr>
                        <td bgcolor='#ffffff' align='left' style='padding:20px 30px 40px 30px;line-height:25px;'>
                            ...
                            <br />
                            <br />
                                Untuk dapat login dengan akun yang telah didaftarkan, anda perlu mengkonfirmasi dengan menggunakan kode di bawah ini.
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td bgcolor='#ffffff' align='left' style='padding:0px 30px 0px 30px;line-height:25px;'>
                            <p style='color:#666666;font-size: 18px;font-weight:bold;margin:0;'>
                                Terima kasih telah mempercayai kami Leon Store sebagai marketplace kesayangan anda!
                            </p>
                        </td>
                    </tr>
                    <tr>
        ...
        <tr>
                    ...
                    <tr>
                        <td bgcolor='#f4f4f4' align='left'
                            ...
                            <p style='margin:0;text-align:center;'>
                                Made with <i class='fa fa-heart' style='color:red;'></i> by Rifki Abdi P.
                            </p>
                        </td>
                    </tr>
                </table>
	        ...
	        if ($data_pengguna['status_akun'] == "Sudah Verifikasi") {
                ...
                if ($conn->query("UPDATE users SET status_akun = 'Sudah Verifikasi' WHERE username = '".$data_kode['username']."'") == true) {
                    ...
                    $_SESSION['hasil'] = array('alert' => 'success', 'pesan' => 'Sip, Verifikasi Akun Berhasil, Silakan Login Untuk Melanjutkan Transaksi. <script>swal({title: "Berhasil!", text: "Akun Kamu Berhasil Di Verifikasi.", icon: "success"}).then(function(){window.location="/auth/login.php";});</script>');
                } else {
                    $_SESSION['hasil'] = array('alert' => 'danger', 'pesan' => 'Ups, Gagal! Sistem Kami Sedang Mengalami Gangguan.<script>swal("Ups Gagal!", "Sistem Kami Sedang Mengalami Gangguan.", "error");</script>');
                }
            }
